...
const Card = (props) => {
  return (
    <>
      <div className="w-[300px] h-[350px] bg-blue-200 py-3 px-6 flex items-center justify-center flex-col rounded-2xl hover:scale-103 transition-transform duration-300 shadow-lg shadow-blue-500/50">
                <img className="object-contain h-[150px] w-[150px]" src={props.src} alt="image item" />
